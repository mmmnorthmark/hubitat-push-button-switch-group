...
. Click *New Library*
. Copy and paste the contents of `WmcPbsgUtilsLib_1.1.0.groovy`
. Click *Save*
...
. Click *New Driver*
. Copy and paste the contents of `WmcPbsg_1.1.0.groovy`
. Click *Save*
...
. Navigate to *Drivers Code*
. Click *New Driver*
. Copy and paste the contents of `WmcPbsgVswt_1.1.0.groovy`
. Click *Save*
...
** *Button Names*: Enter space-delimited button names (e.g., `morning evening night away`)
